...
export default class Pokedex extends Component {
  constructor(props){
    super(props);
    this.state = pokedexData[0];
    this.state.dataSource = pokedexData;
  }
  render() {
    return (
      <View style={{flex:1, backgroundColor:'#e9e9e9', justifyContent: "space-between"}}>
            ...
            <View style={{flexDirection:'row', flex:1, }}>
              <View style={{flex:1, alignItems:'center', justifyContent:'center',}}>
                ...
                <View style={{backgroundColor:"#c3c3c3", padding:5, borderRadius:5, alignSelf:'flex-start', margin:10 }}>
                  <Text style={{color:'#fff', fontSize:14, fontWeight:'600'}}>#{this.state.num}</Text>
                </View>
              </View>
